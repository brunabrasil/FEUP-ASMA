...
class Drone(Agent):
    def __init__(self, jid, password, capacity, autonomy, velocity, latitude, longitude):
        ...
        self.finished_centers = set()  # Centers that dont have anymore order
    ...
    def calculate_duration(self, sender, orders):
        ...
        if ((orders_shortest_distance + distance_return_to_center1 <= self.autonomy )
            ...
            duration = (orders_shortest_distance + distance_drone_to_center) * 1000 / self.velocity    
            return duration, distance_drone_to_center, orders_shortest_distance, last_order_index
        
        else:
            return -1, 0, 0, 0 # RETORNAR ULTIMA ORDER TB (ULTIMA POSICAO)
    ...
    def return_to_a_center(self):
        ...
        self.total_time += min(distance_to_center1, distance_to_center2) * 1000 / self.velocity
    ...
    class DroneHandler(CyclicBehaviour):
        ...
        async def run(self):
            ...
            if msg:
                ...
                # Deal with inform messages of centers
                    ...
                    # The center does not have anymore orders
                        ...
                        if len(self.agent.finished_centers) == 2:
                            ...
                            print(str(self.agent.jid).split("@")[0] + " total time: " + str(self.agent.total_time))
                            self.kill()
